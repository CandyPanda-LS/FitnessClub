      ...
      <div className='container' style={{ marginTop: '30px' }}>
        <div class='row flex-box flex-wrap-wrap'>
          <div class='col-sm-4 flex-box flex-justify-center flex-align-center'>
            <a class='fancybox' rel='gallery1' href='assets/img/people1.jpeg'>
              <img
                class='img-fluid'
          ...
          <div class='col-sm-4 flex-box flex-justify-center flex-align-center'>
            <a class='fancybox' rel='gallery1' href='assets/img/people2.jpeg'>
              <img
                class='img-fluid'
          ...
          <div class='col-sm-4 flex-box flex-justify-center flex-align-center'>
            <a class='fancybox' rel='gallery1' href='assets/img/people4.jpeg'>
              <img
                class='img-fluid'
          ...
          <div class='col-sm-4 flex-box flex-justify-center flex-align-center'>
            <a class='fancybox' rel='gallery1' href='assets/img/people5.jpeg'>
              <img
                class='img-fluid'
          ...
          <div class='col-sm-4 flex-box flex-justify-center flex-align-center'>
            <a class='fancybox' rel='gallery1' href='assets/img/people6.jpeg'>
              <img
                class='img-fluid'
