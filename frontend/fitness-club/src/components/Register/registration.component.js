...
export default class UserRegistration extends Component{
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" onSubmit={this.onSubmit}>
                                ...
                                <label>Gender</label>
                                <div class="col-sm-6">
                                <select value={this.state.gender} name = "gender" id= "gender" onChange = {this.handleChange}>
    ...
    <p>{this.state.status}</p>
                                ...
                                </div><button class="btn btn-primary btn-block text-white btn-user" id = "signup" name = "signup" type="submit" >Sign Up</button>
